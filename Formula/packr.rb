...
class Packr < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/codefuturist/monorepository/releases/download/packr-v3.0.2-test/packr-3.0.2-test-darwin-arm64.tar.gz",
          using: GitHubPrivateRepositoryReleaseDownloadStrategy
      sha256 "4674990ee4f481e29c30e84a2900bb0d2b35178599e1645ec98e861f78580513"
    end
